...
setup(
    ...
    version='0.1.0',
    author='DiskDB Team',
    author_email='transybao93@gmail.com',
    description='Python client for DiskDB - A fast, persistent key-value database',
    long_description=long_description,
    long_description_content_type='text/markdown',
    url='https://github.com/transybao1393/DiskDB',
    project_urls={
        'Bug Reports': 'https://github.com/transybao1393/DiskDB/issues',
        'Source': 'https://github.com/transybao1393/DiskDB',
